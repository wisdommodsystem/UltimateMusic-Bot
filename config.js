...
class EnterpriseConfigurationManager {
    ...
    constructPrimaryConfigurationSchema() {
        return {
             ...
             */
            lavalink: {
                host: EnvironmentVariableProcessor.LAVALINK_HOST || "lavahatry4.techbyte.host", 
                port: EnvironmentVariableProcessor.LAVALINK_PORT || 3000,       
                password: EnvironmentVariableProcessor.LAVALINK_PASSWORD || "NAIGLAVA-dash.techbyte.host", 
             ...
             */
            bot: {
                prefix: EnvironmentVariableProcessor.BOT_PREFIX || "m!",  // 👈 prefix (!, ?, etc)
                ownerIds: ["1329180315314556951"],      // 👈 ADD YOUR DISCORD ID HERE
                embedColor: 0x00AE86,               // 👈 Bot embed color (hex)
                supportServer: "https://discord.gg/r3HGHr6HCW",    // 👈 Your support server link
                defaultStatus: "🎵 Ara Ma3ndek!"         // 👈 Bot status message
            },
